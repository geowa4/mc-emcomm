defmodule McEmcommWeb.Plugs.VerifyResendSignature do
  @moduledoc """
  ...
  Requires the raw body captured by `McEmcommWeb.Plugs.CacheRawBody`.
  """
  @behaviour Plug
  ...
  defp verify(id, ts, body, header) do
    secret =
      Application.fetch_env!(:mc_emcomm, :resend_webhook_secret)
