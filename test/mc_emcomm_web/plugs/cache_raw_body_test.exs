defmodule McEmcommWeb.Plugs.CacheRawBodyTest do
  use ExUnit.Case, async: true

  import Plug.Test
  import Plug.Conn

  alias McEmcommWeb.Plugs.CacheRawBody
...
defmodule McEmcommWeb.Plugs.CacheRawBodyErrorTest do
  use ExUnit.Case, async: true
  ...
  test "a failed webhook body read is passed through untouched" do
    conn = %{
      ...
      | adapter: {McEmcommWeb.FailingBodyAdapter, nil}
    }
