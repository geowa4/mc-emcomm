defmodule McEmcommWeb.TelemetryTest do
  use ExUnit.Case, async: true

  # NB: not aliased as `Telemetry`, which would shadow `Telemetry.Metrics`.
  alias McEmcommWeb.Telemetry, as: AppTelemetry
  ...
  test "the repo metrics use the repo's configured telemetry prefix" do
    prefix =
      Application.fetch_env!(:mc_emcomm, McEmcomm.Repo)[:telemetry_prefix] || [:mc_emcomm, :repo]
